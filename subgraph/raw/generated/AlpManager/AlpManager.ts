...
export class AlpManager__getGlobalShortDeltaResult {
  value0: BigInt;
  value1: boolean;
...
export class AlpManager extends ethereum.SmartContract {
  ...
  ALP_PRECISION(): BigInt {
    let result = super.call("ALP_PRECISION", "ALP_PRECISION():(uint256)", []);

    return result[0].toBigInt();
  }

  try_ALP_PRECISION(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "ALP_PRECISION",
      "ALP_PRECISION():(uint256)",
      []
    );
    if (result.reverted) {
  ...
  getGlobalShortAveragePrice(_token: Address): BigInt {
    let result = super.call(
      "getGlobalShortAveragePrice",
      "getGlobalShortAveragePrice(address):(uint256)",
      [ethereum.Value.fromAddress(_token)]
    );
  ...
  try_getGlobalShortAveragePrice(_token: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getGlobalShortAveragePrice",
      "getGlobalShortAveragePrice(address):(uint256)",
      [ethereum.Value.fromAddress(_token)]
  ...
  getGlobalShortDelta(
    ...
    _price: BigInt,
    _size: BigInt
  ): AlpManager__getGlobalShortDeltaResult {
    let result = super.call(
      "getGlobalShortDelta",
      "getGlobalShortDelta(address,uint256,uint256):(uint256,bool)",
      [
        ethereum.Value.fromAddress(_token),
    ...
    return new AlpManager__getGlobalShortDeltaResult(
      result[0].toBigInt(),
      result[1].toBoolean()
    );
  }
  ...
  try_getGlobalShortDelta(
    ...
    _price: BigInt,
    _size: BigInt
  ): ethereum.CallResult<AlpManager__getGlobalShortDeltaResult> {
    let result = super.tryCall(
      "getGlobalShortDelta",
      "getGlobalShortDelta(address,uint256,uint256):(uint256,bool)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new AlpManager__getGlobalShortDeltaResult(
        value[0].toBigInt(),
        value[1].toBoolean()
      )
    );
  ...
  shortsTrackerAveragePriceWeight(): BigInt {
    let result = super.call(
      "shortsTrackerAveragePriceWeight",
      "shortsTrackerAveragePriceWeight():(uint256)",
      []
    );
  ...
  try_shortsTrackerAveragePriceWeight(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "shortsTrackerAveragePriceWeight",
      "shortsTrackerAveragePriceWeight():(uint256)",
      []
...
export class SetShortsTrackerCall extends ethereum.Call {
  get inputs(): SetShortsTrackerCall__Inputs {
    return new SetShortsTrackerCall__Inputs(this);
  }

  get outputs(): SetShortsTrackerCall__Outputs {
    return new SetShortsTrackerCall__Outputs(this);
  }
}

export class SetShortsTrackerCall__Inputs {
  _call: SetShortsTrackerCall;

  constructor(call: SetShortsTrackerCall) {
    this._call = call;
  }
...
export class SetShortsTrackerCall__Outputs {
  _call: SetShortsTrackerCall;
...
export class SetShortsTrackerAveragePriceWeightCall extends ethereum.Call {
  get inputs(): SetShortsTrackerAveragePriceWeightCall__Inputs {
    return new SetShortsTrackerAveragePriceWeightCall__Inputs(this);
  }

  get outputs(): SetShortsTrackerAveragePriceWeightCall__Outputs {
    return new SetShortsTrackerAveragePriceWeightCall__Outputs(this);
  }
}

export class SetShortsTrackerAveragePriceWeightCall__Inputs {
  _call: SetShortsTrackerAveragePriceWeightCall;

  constructor(call: SetShortsTrackerAveragePriceWeightCall) {
    this._call = call;
  }

  get _shortsTrackerAveragePriceWeight(): BigInt {
    return this._call.inputValues[0].value.toBigInt();
  }
}

export class SetShortsTrackerAveragePriceWeightCall__Outputs {
  _call: SetShortsTrackerAveragePriceWeightCall;
