...
export class PositionRouter extends ethereum.SmartContract {
  ...
  decreasePositionRequests(
    ...
    let result = super.call(
      "decreasePositionRequests",
      "decreasePositionRequests(bytes32):(address,address,uint256,uint256,bool,address,uint256,uint256,uint256,uint256,uint256,bool)",
  ...
  increasePositionRequests(
    ...
    let result = super.call(
      "increasePositionRequests",
      "increasePositionRequests(bytes32):(address,address,uint256,uint256,uint256,bool,uint256,uint256,uint256,uint256,bool)",
      [ethereum.Value.fromFixedBytes(param0)]
    );
