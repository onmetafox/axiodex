...
export class Order extends Entity {
  ...
  set path(value: Array<string> | null) {
    if (value === null) {
      this.unset("path");
    } else {
      this.set("path", Value.fromStringArray(value as Array<string>));
    }
  }

  get indexToken(): string | null {
    let value = this.get("indexToken");
    if (value === null || value.kind == ValueKind.NULL) {
      return null;
    } else {
  ...
  set indexToken(value: string | null) {
    if (value === null) {
      this.unset("indexToken");
    } else {
      this.set("indexToken", Value.fromString(value as string));
    }
  }
  ...
  get triggerAboveThreshold(): boolean {
    let value = this.get("triggerAboveThreshold");
    return value.toBoolean();
  }

  set triggerAboveThreshold(value: boolean) {
    this.set("triggerAboveThreshold", Value.fromBoolean(value));
  }

  get triggerRatio(): BigInt {
    let value = this.get("triggerRatio");
    return value.toBigInt();
  }

  set triggerRatio(value: BigInt) {
    this.set("triggerRatio", Value.fromBigInt(value));
  }
...
export class HourlyGlpStat extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save HourlyGlpStat entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save HourlyGlpStat entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("HourlyGlpStat", id.toString(), this);
  }

  static load(id: string): HourlyGlpStat | null {
    return store.get("HourlyGlpStat", id) as HourlyGlpStat | null;
  }
...
export class GlpStat extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save GlpStat entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save GlpStat entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("GlpStat", id.toString(), this);
  }

  static load(id: string): GlpStat | null {
    return store.get("GlpStat", id) as GlpStat | null;
  }
  ...
  get distributedEsgmx(): BigInt {
    let value = this.get("distributedEsgmx");
    return value.toBigInt();
  }

  set distributedEsgmx(value: BigInt) {
    this.set("distributedEsgmx", Value.fromBigInt(value));
  }

  get distributedEsgmxCumulative(): BigInt {
    let value = this.get("distributedEsgmxCumulative");
    return value.toBigInt();
  }

  set distributedEsgmxCumulative(value: BigInt) {
    this.set("distributedEsgmxCumulative", Value.fromBigInt(value));
  }

  get distributedEsgmxUsd(): BigInt {
    let value = this.get("distributedEsgmxUsd");
    return value.toBigInt();
  }

  set distributedEsgmxUsd(value: BigInt) {
    this.set("distributedEsgmxUsd", Value.fromBigInt(value));
  }

  get distributedEsgmxUsdCumulative(): BigInt {
    let value = this.get("distributedEsgmxUsdCumulative");
    return value.toBigInt();
  }

  set distributedEsgmxUsdCumulative(value: BigInt) {
    this.set("distributedEsgmxUsdCumulative", Value.fromBigInt(value));
  }
...
export class GmxStat extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save GmxStat entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save GmxStat entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("GmxStat", id.toString(), this);
  }

  static load(id: string): GmxStat | null {
    return store.get("GmxStat", id) as GmxStat | null;
  }
