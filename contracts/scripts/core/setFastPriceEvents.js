...
async function main() {
  ...
  const fastPriceFeed2 = await contractAt("FastPriceFeed", await vaultPriceFeed2.secondaryPriceFeed())
  const fastPriceEvents = await contractAt("FastPriceEvents", await fastPriceFeed1.fastPriceEvents())
