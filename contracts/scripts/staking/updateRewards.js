...
async function getGoerliValues(signer) {
  const rewardToken = await contractAt("Token", "0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889")   // WMATIC
  const tokenDecimals = 18

  const rewardTrackerArr = [
    {
      name: "feeGmxTracker",
      address: "0x40f057248e4BA492064995D8066aec6B754a67f3",
      transferAmount: "5112"
    },
    {
      name: "feeGlpTracker",
      address: "0x06158CB4Dce4eA438fee783B4f0b123bB03d639C",
      transferAmount: "26304"
    }
  ]
...
async function getFantomValues(signer) {
  const rewardToken = await contractAt("Token", "0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889")   // WMFTM
  const tokenDecimals = 18
