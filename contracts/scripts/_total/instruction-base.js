module.exports = [
    ...
    { func: "wallet", as: "localPriceUpdater", value: "axion local keeper" },
    { func: "wallet", as: "remotePriceUpdater", value: "axion backend keeper" },
    ...
    { func: "load", artifact: "contracts/tokens/General.sol:GeneralToken", as: "USDC", address: "0x833589fcd6edb6e08f4c7c32d4f71b54bda02913" },
    // { func: "load", artifact: "contracts/tokens/General.sol:GeneralToken", as: "ETH", address: "0x3677bd78ccf4d299328ecfba61790cf8dbfcf686" },
    { func: "load", artifact: "contracts/tokens/General.sol:GeneralToken", as: "BTC", address: "0x236aa50979d5f3de3bd1eeb40e81137f22ab794b" },
    { func: "load", artifact: "contracts/tokens/General.sol:GeneralToken", as: "AXN", address: "0xec7acba6fedb7ebfbc0f44f8f0bc6fc39543e28a" },
    ...
    { func: "load", artifact: "PriceFeed", as: "PriceFeedUSDC", address: "0x7e860098F58bBFC8648a4311b374B1D669a2bc6B" },
    ...
    // { func: "wallet", as: "_keeper", value: "AxionDex:PLS:PriceFeed:3" }, { func: "call", contract: "PriceFeedETH", method: "setAdmin", args: ["${_keeper.address}", true] }, 
    // { func: "wallet", as: "_keeper", value: "AxionDex:PLS:PriceFeed:4" }, { func: "call", contract: "PriceFeedETH", method: "setAdmin", args: ["${_keeper.address}", true] }, 
  ...
  // { func: "wallet", as: "_keeper", value: "AxionDex:HEX:PriceFeed:0" }, { func: "call", contract: "PriceFeedHEX", method: "setAdmin", args: ["${_keeper.address}", true] }, 
    ...
    { func: "call", contract: "EsAXN", method: "setMinter", args: ["${AxnVester.address}", true] },
    { func: "call", contract: "EsAXN", method: "setMinter", args: ["${AlpVester.address}", true] },
  ...
  // { func: "call", contract: "AlpRewardRouter", method: "mintAndStakeAlp", args: [
    ...
    { func: "call", contract: "Router", method: "addPlugin", args: ["${OrderBook.address}"] },
    ...
    { func: "load", artifact: "contracts/uniswap/Router.sol:PancakeRouter", address: "0x8cFe327CEc66d1C090Dd72bd0FF11d690C33a2Eb" },
    { func: "load", artifact: "contracts/uniswap/Factory.sol:PancakeFactory", address: "0x02a84c1b3BBD7401a5f7fa98a384EBC70bB5749E" },
    ...
    //     "${USDC.address}", "${AXN.address}", "${parseUnits('100', 6)}", "${parseEther('100')}", 0, 0, "${admin.address}", "${block.timestamp + 1000}"
    // ]},
    ...
    // { func: "call", contract: "USDC", method: "approve", args: ["${Router.address}", "${parseUnits('100', 6)}"] },
    // { func: "call", contract: "Router", method: "directPoolDeposit", args: ["${USDC.address}", "${parseUnits('100', 6)}"] },
    // { func: "call", contract: "BTC", method: "approve", args: ["${Router.address}", "${parseUnits('0.1', 8)}"] },
    // { func: "call", contract: "Router", method: "directPoolDeposit", args: ["${BTC.address}", "${parseUnits('0.1', 8)}"] },
