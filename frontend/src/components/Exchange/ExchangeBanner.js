  ...
  return (
    <div className="ExchangeBanner">
      <p className="ExchangeBanner-text">
        <Trans>
          Trade on AXN and win <span className="ExchangeBanner-price">$250.000</span> in prizes! Live until November
          30th,{" "}
          <ExternalLink
            href="https://medium.com/@axn.finance/gmx-trading-competition-win-250-000-usd-in-prizes-1346504b96f6"
