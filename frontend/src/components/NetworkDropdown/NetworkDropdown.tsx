...
function NavIcons({ selectorLabel }) {
  ...
  const drop = getIcon("common", "drop");
  ...
  return (
    <>
      ...
      <button className="transparent">
        ...
        <img className="network-dropdown-icon" src={drop} alt={selectorLabel} />
      </button>
    </>
  );
}
      ...
      <Menu.Item key={network.value}>
        ...
        >
          ...
          <div className="network-dropdown-menu-item-img">
            <div className={cx({"active-dot": selectorLabel === network.label}, {[selectorLabel]: selectorLabel === network.label})} />
          </div>
        </div>
      </Menu.Item>
    );
