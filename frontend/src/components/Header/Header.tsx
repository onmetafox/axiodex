...
import logoImg from "img/ic_axn_40.svg";
import logoSmallImg from "img/ic_axn_40.svg";
  ...
  return (
    <>
      ...
      <header>
        <div className="App-header large">
          <div className="App-header-container-left">
            <a className="App-header-link-main" href={getHomeUrl()}>
              <img src={logoImg} className="big" alt="AXN Logo" />
              <img src={logoSmallImg} className="small" alt="AXN Logo" />
            </a>
            {isHomeSite() ? (
        ...
        <div className= {cx ("App-header", "tiny", {active: isDrawerVisible})} >
          <div
