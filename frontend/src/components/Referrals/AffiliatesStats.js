                            ...
                            <div className="info">
                              <TooltipWithPortal
                                ...
                                renderContent={() => (
                                  <div>
                                    <Trans>
                                      This code is not yet registered, you will not receive rebates
                                      there.
                                      <br />
                                      <br />
                                      Switch your network to create this code.
                                    </Trans>
                                  </div>
                                )}
                              />
                            ...
                            <div className="info">
                              <TooltipWithPortal
                                ...
                                renderContent={() => (
                                  <div>
                                    <Trans>
                                      This code has been taken by someone else on chain, you will not receive rebates
                                      from traders using this code.
                                    </Trans>
                                  </div>
                                )}
                              />
