...
import ALP from "pages/ALP/Alp";
import Axes from "pages/AxEs/Axes";
import Overview from "pages/Overview/Overview";
import SideBar from "components/SideBar/SideBar";
import {Dashboard2, Dashboard3} from "pages/Dashboard/Dashboard";
    ...
    if (!hasMetaMaskWalletExtension()) {
      helperToast.error(
        <div>
          ...
          {userOnMobileDevice ? (
            <Trans>
              <ExternalLink href="https://metamask.io">Install MetaMask</ExternalLink>, and use AXN with its built-in
              browser.
            </Trans>
          ) : (
            <Trans>
              <ExternalLink href="https://metamask.io">Install MetaMask</ExternalLink> to start using AXN.
            </Trans>
          )}
        </div>
      );
    ...
    if (!hasCoinBaseWalletExtension()) {
      helperToast.error(
        <div>
          ...
          {userOnMobileDevice ? (
            <Trans>
              <ExternalLink href="https://www.coinbase.com/wallet">Install Coinbase Wallet</ExternalLink>, and use AXN
          ...
          {!isHome && (
            <>
              ...
              <Switch>
                ...
                <Route exact path="/stake-nft" setPendingTxns={setPendingTxns}>
                  <StakeNft />
                </Route>
                {/* <Route exact path="/nft">
                  <NftMint connectWallet={connectWallet} setPendingTxns={setPendingTxns} />
                </Route> */}
                <Route exact path="/your_nft">
                  <YourNft />
                </Route>
