...
export default function StakeV2({ setPendingTxns, connectWallet }) {
  ...
  if (totalRewardTokensAndGlp && totalRewardTokensAndGlp.gt(0)) {
    ...
    if (processedData.gmxInStakedGmx && processedData.gmxInStakedGmx.gt(0)) {
      gmxAmountStr = formatAmount(processedData.gmxInStakedGmx, 18, 2, true) + " AXN";
    }
    let esGmxAmountStr;
    if (processedData.esGmxInStakedGmx && processedData.esGmxInStakedGmx.gt(0)) {
      esGmxAmountStr = formatAmount(processedData.esGmxInStakedGmx, 18, 2, true) + " esAXN";
    }
    let mpAmountStr;
    ...
    <div className="default-container page-layout">
      ...
      <div className="section-title-block">
        ...
        <div className="section-title-content">
          ...
          <div className="Page-description">
            {/* <Trans>
              Stake <ExternalLink href="https://gmxio.gitbook.io/gmx/tokenomics">AXN</ExternalLink> and{" "}
              <ExternalLink href="https://gmxio.gitbook.io/gmx/glp">TLP</ExternalLink> to earn rewards.
            </Trans> */}
            <Trans>Stake AXN and ALP to earn rewards.</Trans>
          </div>
      ...
      <div className="StakeV2-content">
        <div className="StakeV2-cards">
          <div className="App-card StakeV2-gmx-card">
            <div className="App-card-title">AXN</div>
            ...
            <div className="App-card-content">
                ...
                <div>
                  ...
                  {gmxPrice && (
                    <Tooltip
                      position="right-bottom"
                      className="nowrap"
                      handle={"$" + formatAmount(gmxPrice, USD_DECIMALS, 3, true)}
                      renderContent={() => (
                        <>
                          {/* <StatsTooltipRow
                            label={t`Price on Shibarium`}
                            value={formatAmount(gmxPriceFromAvalanche, USD_DECIMALS, 3, true)}
                          />
                          <StatsTooltipRow
                            label={t`Price on Ethereum`}
                            value={formatAmount(gmxPriceFromArbitrum, USD_DECIMALS, 3, true)}
                          /> */}
                          <StatsTooltipRow
                            label={t`Price on Goerli`}
                            value={formatAmount(gmxPriceFromGoerli, USD_DECIMALS, 3, true)}
                          />
                          <StatsTooltipRow
                            label={t`Price on Puppy`}
                            value={formatAmount(gmxPriceFromPuppy, USD_DECIMALS, 3, true)}
                          />
                        </>
                      )}
                    />
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "gmxBalance", 18, 2, true)} AXN ($
                  {formatKeyAmount(processedData, "gmxBalanceUsd", USD_DECIMALS, 3, true)})
                </div>
              </div>
              <div className="App-card-row">
                <div className="label">
                ...
                <div>
                  {formatKeyAmount(processedData, "gmxInStakedGmx", 18, 2, true)} AXN ($
                  {formatKeyAmount(processedData, "gmxInStakedGmxUsd", USD_DECIMALS, 3, true)})
                </div>
              </div>
              <div className="App-card-divider"></div>
              <div className="App-card-row">
              ...
              <div className="App-card-row">
                ...
                <div>
                  <Tooltip
                    handle={`$${formatKeyAmount(processedData, "totalGmxRewardsUsd", USD_DECIMALS, 3, true)}`}
                    position="right-bottom"
                    renderContent={() => {
                      return (
                        <>
                          <StatsTooltipRow
                            ...
                            value={`${formatKeyAmount(
                              ...
                              18,
                              4
                            )} ($${formatKeyAmount(processedData, "feeGmxTrackerRewardsUsd", USD_DECIMALS, 3, true)})`}
                            showDollar={false}
                          />
                          <StatsTooltipRow
                            label="Escrowed AXN"
                    ...
                    <Tooltip
                      ...
                      renderContent={() => (
                        <StatsTooltip
                          ...
                          goerliValue={goerliGmxStaked}
                          puppyValue={puppyGmxStaked}
                          total={totalGmxStaked}
              ...
              <div className="App-card-row">
                ...
                {totalGmxSupply && (
                  <div>
                    {formatAmount(totalGmxSupply, 18, 0, true)} AXN ($
              ...
              <div className="App-card-options">
                {/* <Link className="App-button-option App-card-option" to="/buy_tail">
                  <Trans>Buy AXN</Trans>
                </Link> */}
                <ExternalLink
            ...
            <div className="App-card-content">
              <div className="App-card-row">
                ...
                <div>
                  ...
                  {formatKeyAmount(processedData, "totalNativeTokenRewardsUsd", USD_DECIMALS, 3, true)})
                </div>
              </div>
              <div className="App-card-row">
                <div className="label">AXN</div>
                <div>
                  {formatKeyAmount(processedData, "totalVesterRewards", 18, 4, true)} ($
                  {formatKeyAmount(processedData, "totalVesterRewardsUsd", USD_DECIMALS, 3, true)})
                </div>
              </div>
              <div className="App-card-row">
                <div className="label">
                  <Trans>Escrowed AXN</Trans>
                </div>
                <div>
                  {formatKeyAmount(processedData, "totalEsGmxRewards", 18, 4, true)} ($
                  {formatKeyAmount(processedData, "totalEsGmxRewardsUsd", USD_DECIMALS, 3, true)})
                </div>
              </div>
              <div className="App-card-row">
                <div className="label">
              ...
              <div className="App-card-row">
                ...
                <div>${formatKeyAmount(processedData, "totalRewardsUsd", USD_DECIMALS, 3, true)}</div>
              </div>
          ...
          <div className="App-card">
            <div className="App-card-title">ALP ({chainName})</div>
            <div className="App-card-divider"></div>
            <div className="App-card-content">
              <div className="App-card-row">
                <div className="label">
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "glpBalance", TLP_DECIMALS, 2, true)} ALP ($
                  {formatKeyAmount(processedData, "glpBalanceUsd", USD_DECIMALS, 3, true)})
                </div>
              </div>
              <div className="App-card-row">
                <div className="label">
                      ...
                      return (
                        <>
                          ...
                          <Trans>
                            ...
                            <br />
                            {/* <br />
                            Historical ALP APRs can be checked in this{" "}
              ...
              <div className="App-card-row">
                ...
                <div>
                  <Tooltip
                    handle={`$${formatKeyAmount(processedData, "totalGlpRewardsUsd", USD_DECIMALS, 3, true)}`}
                    position="right-bottom"
                    renderContent={() => {
                      return (
                        <>
                          <StatsTooltipRow
                            ...
                            value={`${formatKeyAmount(
                              ...
                              18,
                              4
                            )} ($${formatKeyAmount(processedData, "feeGlpTrackerRewardsUsd", USD_DECIMALS, 3, true)})`}
                            showDollar={false}
                          />
                          <StatsTooltipRow
                            label="Escrowed AXN"
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "glpSupply", 18, 2, true)} ALP ($
                  {formatKeyAmount(processedData, "glpSupplyUsd", USD_DECIMALS, 3, true)})
                </div>
              </div>
              <div className="App-card-row">
                <div className="label">
          ...
          <div className="App-card">
            ...
            <div className="App-card-content">
              <div className="App-card-row">
                ...
                <div>${formatAmount(gmxPrice, USD_DECIMALS, 3, true)}</div>
              </div>
              <div className="App-card-row">
                <div className="label">
                  <Trans>Wallet</Trans>
                ...
                <div>
                  {formatKeyAmount(processedData, "esGmxBalance", 18, 2, true)} esAXN ($
                  {formatKeyAmount(processedData, "esGmxBalanceUsd", USD_DECIMALS, 3, true)})
                </div>
              </div>
              <div className="App-card-row">
                <div className="label">
                ...
                <div>
                  {formatKeyAmount(processedData, "esGmxInStakedGmx", 18, 2, true)} esAXN ($
                  {formatKeyAmount(processedData, "esGmxInStakedGmxUsd", USD_DECIMALS, 3, true)})
                </div>
              </div>
              <div className="App-card-divider"></div>
              <div className="App-card-row">
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "stakedEsGmxSupply", 18, 0, true)} esAXN ($
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatAmount(esGmxSupply, 18, 0, true)} esAXN ($
      ...
      <div>
        <div className="Tab-title-section">
          ...
          <div className="Page-description">
            <Trans>
              Convert esAXN tokens to AXN tokens.
              <br />
              {/* Please read the{" "}
            ...
            <div className="App-card StakeV2-gmx-card">
              ...
              <div className="App-card-content">
                        ...
                        return (
                          <div>
                            <Trans>
                              ...
                              converted to AXN from the{" "}
                              {formatKeyAmount(vestingData, "gmxVesterVestedAmount", 18, 4, true)} esAXN deposited for
                              vesting.
                            </Trans>
                          </div>
                        );
                ...
                <div className="App-card-row">
                  ...
                  <div>
                    <Tooltip
                      handle={`${formatKeyAmount(vestingData, "gmxVesterClaimable", 18, 4, true)} AXN`}
                      position="right-bottom"
                      renderContent={() => (
                        <Trans>
                          {formatKeyAmount(vestingData, "gmxVesterClaimable", 18, 4, true)} AXN tokens can be claimed,
            ...
            <div className="App-card StakeV2-gmx-card">
              ...
              <div className="App-card-content">
                <div className="App-card-row">
                  ...
                  <div>{formatAmount(processedData.glpBalance, 18, 2, true)} TLP</div>
                </div>
                <div className="App-card-row">
                  <div className="label">
                    <Trans>Reserved for Vesting</Trans>
                        ...
                        return (
                          <div>
                            <Trans>
                              ...
                              converted to AXN from the{" "}
                              {formatKeyAmount(vestingData, "glpVesterVestedAmount", 18, 4, true)} esAXN deposited for
                              vesting.
                            </Trans>
                          </div>
                        );
                ...
                <div className="App-card-row">
                  ...
                  <div>
                    <Tooltip
                      handle={`${formatKeyAmount(vestingData, "glpVesterClaimable", 18, 4, true)} AXN`}
                      position="right-bottom"
                      renderContent={() => (
                        <Trans>
                          {formatKeyAmount(vestingData, "glpVesterClaimable", 18, 4, true)} AXN tokens can be claimed,
                          use the options under the Total Rewards section to claim them.
                        </Trans>
                      )}
                    />
