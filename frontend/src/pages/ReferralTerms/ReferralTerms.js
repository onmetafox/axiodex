      ...
      <div className="default-container Page page-layout">
        <div>
          <div className="Page-title-section center">
            <div className="Page-title">AXN Referral Program</div>
          ...
          <div className="content">
            <div className="section">
              <p className="body-text">
                Welcome to axnfinance.com ("we," "us," or "our"), the informational resource for AXN Protocol, as defined below.
              </p>
              <p className="body-text">
                axnfinance.com provides information and resources about the fundamentals of the decentralized non-custodial
                protocol called the AXN Protocol (the "AXN Protocol," "Protocol," or "AXN DApp"). axnfinance.com is not an
              ...
              <p className="body-text">
                ...
                Affiliate"), explains the terms and conditions by which you may use the AXN Referral Program ("Referral
            ...
            <div className="section">
              ...
              <p className="body-text">
                The Referral Program allows you to advertise the AXN DApp, thereby driving traffic to it, whereby you
                may earn a portion of the fees generated ("Rebates") if a person that is not you ("Trader," "Referred
                User") trades in the AXN DApp after being referred to it from a hyperlink ("Link") or manually input
                code ("Referral Code"). The Trader will benefit from a fee discount ("Discount") associated with the
                Referrer's tier.
              </p>
              <p className="body-text">
                After being referred to the AXN DApp from a Link, the Trader's browser will save your Referral Code,
            ...
            <div className="section">
              ...
              <p className="body-text">
                2.1 As an Affiliate, AXN DApp provides you with the Links and Referral Codes necessary to promote the
                AXN Protocol. You acknowledge and agree it is your sole responsibility to indicate your correct Referral
                Code. You may promote the AXN Protocol offers in any manner you choose unless it misleads someone about
                the AXN Protocol.
              </p>
              <p className="body-text">
                2.2 axn.com is not responsible for (i) lost sales or lost opportunity to earn Rebates due to any cause,
              ...
              <p className="body-text">
                2.3 You will be excluded from the Referral Program, following the directives of the AXN tokenholders:
            ...
            <div className="section">
              ...
              <p className="body-text">
                axnfinance.com is under no obligation for Rebates or Discounts to any Referrer or Trader. Rebates and Discounts
                are handled following the directives of the AXN tokenholders.
              </p>
              {/* <p className="body-text">
            ...
            <div className="section">
              ...
              <p className="body-text">
                Under no circumstances shall axnfinance.com be liable for any direct, indirect, incidental, punitive, special,
              ...
              <p className="body-text">
                In no event shall axnfinance.com's aggregate liability arising out of or in connection with the Site exceed five
            ...
            <div className="section">
              ...
              <p className="body-text">
                You will defend, indemnify, and hold harmless axnfinance.com, its affiliates, members, member, managers,
                ...
                service(s) provided by axnfinance.com, or your use of the service(s) provided by axnfinance.com, including, without
            ...
            <div className="section">
              ...
              <p className="body-text">
                The Referral Program runs independently from axnfinance.com, which the token holders of AXN determine. Due to
              ...
              <p className="body-text">
                axnfinance.com will not be liable for any losses suffered by you resulting from any modification to the Referral
              ...
              <p className="body-text">
                axnfinance.com may revise these Terms from time to time. We will notify you by updating the date at the top of
                the Terms and maintaining a current version. The most current version of the Terms will always be at
                https://axn.finance/referral-terms. All modifications will be effective when they are posted. By using the
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                only agreement between you and axnfinance.com concerning the subject matter of these Terms and supersede all
              ...
              <p className="body-text">
                ...
                unenforceable or invalid as a whole. axnfinance.com will amend or replace such provision with one that is valid
              ...
              <p className="body-text">
                ...
                or in connection with any change of control. axnfinance.com may assign or transfer any or all of our rights or
                obligations under these Terms, in whole or part, without notice or obtaining your consent or approval.
              </p>
              <p className="body-text">
                8.6 axnfinance.com will have no responsibility or liability for any failure or delay in performance of the Site,
            ...
            <div className="section">
              ...
              <p className="body-text">
                If you have any questions about these Terms, the Site, or the Interface, please get in touch with axnfinance.com
