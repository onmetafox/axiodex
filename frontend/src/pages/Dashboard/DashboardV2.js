...
export default function DashboardV2() {
  ...
  // const eth = infoTokens[getTokenBySymbol("ETH").address];
        ...
        {/* <div className="section-title-block">
          ...
          <div className="section-title-content">
            ...
            <div className="Page-description">
              ...
              {chainId === ARBITRUM && <ExternalLink href="https://stats.axn.finanace">https://stats.axn.finanace</ExternalLink>}
              {chainId === AVALANCHE && (
                <ExternalLink href="https://stats.axn.finanace/avalanche">https://stats.axn.finanace/avalanche</ExternalLink>
              )}
              .
            </div>
          </div>
        ...
        <div className="DashboardV2-content">
            ...
            <div className="App-card">
              ...
              <div className="App-card-content">
                <div className="App-card-row">
                  ...
                  <div>
                    <TooltipComponent
                      handle={`$${formatAmount(tvl, USD_DECIMALS, 2, true)}`}
                      position="right-bottom"
                      renderContent={() => (
                        <span>{t`Assets Under Management: AXN staked (All chains) + ALP pool (${chainName}).`}</span>
                      )}
                    />
                  </div>
                </div>
                <div className="App-card-row">
                  ...
                  <div>
                    <TooltipComponent
                      handle={`$${formatAmount(aum, USD_DECIMALS, 2, true)}`}
                      position="right-bottom"
                      renderContent={() => (
                        <Trans>
                          <p>Total value of tokens in ALP pool ({chainName}).</p>
                          <p>
                            Other websites may show a higher value as they add positions' collaterals to the ALP pool.
                          </p>
                        </Trans>
                      )}
                    />
                ...
                <div className="App-card-row">
                  ...
                  <div>
                    ${formatAmount(volume24H, USD_DECIMALS, 2, true)}
                    <TooltipComponent
                      position="right-bottom"
                      className="nowrap"
                      handle={`$${formatAmount(currentVolumeInfo?.[chainId]?.totalVolume, USD_DECIMALS, 2, true)}`}
                      renderContent={() => (
                        <StatsTooltip
                          title={t`Volume`}
            ...
            <div className="App-card">
              ...
              <div className="App-card-content">
                <div className="App-card-row">
                  ...
                  <div>
                    ${formatAmount(total_Fees, USD_DECIMALS, 2, true)}
                    <TooltipComponent
                      position="right-bottom"
                      className="nowrap"
                ...
                <div className="App-card-row">
                  ...
                  <div>
                    ${formatAmount(total_Volume, USD_DECIMALS, 2, true)}
                    <TooltipComponent
                      position="right-bottom"
                      className="nowrap"
                      handle={`$${formatAmount(totalVolume?.[chainId], USD_DECIMALS, 2, true)}`}
                      renderContent={() => (
                        <StatsTooltip
          ...
          <div className="DashboardV2-token-cards">
                ...
                <div className="stats-block">
                  <div className="App-card-title">
                    <div className="App-card-title-mark">
                      <div className="App-card-title-mark-icon">
                        <img src={currentIcons.tail} width="40" alt="AXN Token Icon" />
                        <img src={getIcon(chainId, "icon")} alt="" className="selected-network-symbol" />
                      </div>
                      <div className="App-card-title-mark-info">
                        <div className="App-card-title-mark-title">AXN</div>
                        <div className="App-card-title-mark-subtitle">AXN</div>
                      </div>
                      <div>
                        <AssetDropdown assetSymbol="AXN" />
                      </div>
                    </div>
                  </div>
                  <div className="App-card-divider"></div>
                  <div className="App-card-content">
                    ...
                    <div className="App-card-row">
                      ...
                      <div>{formatAmount(totalGmxSupply, AXN_DECIMALS, 0, true)} AXN</div>
                    </div>
                    <div className="App-card-row">
                      <div className="label">
                      ...
                      <div>
                        <TooltipComponent
                          position="right-bottom"
                          className="nowrap"
                          handle={`$${formatAmount(stakedGmxSupplyUsd, USD_DECIMALS, 2, true)}`}
                          renderContent={() => (
                            <StatsTooltip
                              title={t`Staked`}
                              total={totalStakedGmx}
                              decimalsForConversion={AXN_DECIMALS}
                              showDollar={false}
                            />
                          )}
                        />
                    ...
                    <div className="App-card-row">
                      ...
                      <div>${formatAmount(gmxMarketCap, USD_DECIMALS, 2, true)}</div>
                    </div>
                  </div>
                </div>
              ...
              <div className="App-card">
                <div className="stats-block">
                  <div className="App-card-title">
                    <div className="App-card-title-mark">
                      <div className="App-card-title-mark-icon">
                        <img src={currentIcons.tlp} width="40" alt="ALP Icon" />
                        <img src={getIcon(chainId, "icon")} alt="" className="selected-network-symbol" />
                      </div>
                      <div className="App-card-title-mark-info">
                  ...
                  <div className="App-card-content">
                    ...
                    <div className="App-card-row">
                      ...
                      <div>{formatAmount(glpSupply, TLP_DECIMALS, 0, true)} TLP</div>
                    </div>
                    <div className="App-card-row">
                      <div className="label">
                        <Trans>Total Staked</Trans>
                      </div>
                      <div>${formatAmount(glpMarketCap, USD_DECIMALS, 2, true)}</div>
                    </div>
                    <div className="App-card-row">
                      <div className="label">
                        <Trans>Market Cap</Trans>
            ...
            <div className="token-table-wrapper App-card">
              <div className="App-card-title">
                <Trans>ALP Index Composition</Trans> <img src={currentIcons.network} width="16" alt="Network Icon" />
              </div>
              <div className="App-card-divider"></div>
