...
function AssetDropdown({ assetSymbol, assetInfo }: Props) {
  ...
  let { coingecko, reserves } = ICONLINKS[assetSymbol] || {};
      ...
      <Menu.Items as="div" className="asset-menu-items">
        ...
        <Menu.Item>
          <>
            ...
            {puppy && (
              <ExternalLink href={puppy} className="asset-item">
                <img className="asset-item-icon" src={puppyIcon} alt="Open in explorer" />
                <p>
                  <Trans>Open in Explorer</Trans>
                </p>
              </ExternalLink>
