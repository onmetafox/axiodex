        ...
        <div className="section-title-block">
          ...
          <div className="section-title-content">
            ...
            <div className="Page-description">
              <Trans>Job openings at AXN.</Trans>
            </div>
          </div>
        </div>
...
function NoJob() {
  return (
    <Card title={t`No open positions at AXN currently`}>
      <div className="body-para">
        <p className="subheading">
          <Trans>
            AXN is not actively looking for new hires at the moment. However, if you think you can contribute to the
            project, please email <ExternalLink href="mailto:jobs@axn.finance">jobs@axn.finance</ExternalLink>.
          </Trans>
        </p>
      </div>
    </Card>
...
//     <ul>
//       <li>Work closely with the AXN team on the AXN front-end website.</li>
...
//       </ul>
//       <p>The salary is 60,000 to 120,000 USD + 1,000 to 3,000 AXN a year.</p>
//       <p className="jobs-contact">
//         If the job suits you, please get in touch with{" "}
//         <a target="_blank" href="mailto:jobs@axn.finanace" rel="noopener noreferrer">
//           jobs@axn.finanace
//         </a>{" "}
